...
export const createApis = (alovaInstance: Alova<AlovaGenerics>, configMap: any) => {
	const Apis = new Proxy({} as BaseApis, {
		get(_, property) {
			return createFunctionalProxy([property], alovaInstance, configMap)
		},
	})
	// define global variable `Apis`
	;(globalThis as any).BaseApis = Apis
	return Apis
}
type MethodConfig<T> = AlovaMethodCreateConfig<
	...
	T
>
type APISofParameters<Tag extends string, Url extends string> = Tag extends keyof BaseApis
	? Url extends keyof BaseApis[Tag]
		? BaseApis[Tag][Url] extends (...args: any) => any
			? Parameters<BaseApis[Tag][Url]>
			: any
		: any
	: any
